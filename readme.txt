...
3) Run the mongoose server and shell using the command mongod and mongo for shell (already posted to use the mongo shell and run the server on the instagram) 
...
5) Then open the file relation.js (Go through all the text,codings, also i commented all the things that we used)
   Follow all the steps that i written in the enter.js file
6) you can run all the files at the terminal by using the node file_name.js
